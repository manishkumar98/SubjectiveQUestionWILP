      ...
      case 6:
        return (
          <div>
            ...
            <ul>
              <li>
                <strong>Write short note on AI.</strong> {answers.answer1}
              </li>
              <li>
                <strong>Write short note on ML.</strong> {answers.answer2}
              </li>
              <li>
                <strong>Write short note on Data Science.</strong>{" "}
                {answers.answer3}
              </li>
              <li>
                <strong>Write short note on NLP.</strong> {answers.answer4}
              </li>
              <li>
                <strong>Write short note on Data Mining.</strong>{" "}
                {answers.answer5}
              </li>
            </ul>
